 ...
 */
const searchArea = (range: any[], pageIndexNumMap: any, pageIndex: number): any => {
 ...
 * @returns {object} pageIndexNumMap object
 */
export const findPageNumbers = (pageIndexNumMap: any, pageIndex: number, items: any[]): any => {
 ...
 */
export const findFirstPage = (pageIndexNumMap: any): any => {
	let counter = 0
	const keys: any[] = Object.keys(pageIndexNumMap)
	...
	for (let x = 0; x < keys.length - 1; x++) {
		...
		let pageDetails: any[] = (x > 0) ? Object.entries(pageIndexNumMap)[x - 1] : Object.entries(pageIndexNumMap)[x]
 ...
 */
export const removePageNumber = (textContent: any, pageNum: number): any => {

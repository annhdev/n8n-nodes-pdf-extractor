...
export function linesToText(lineItems: any[], disableInlineFormats: boolean) {
	let text = '';
	let openFormat: any;
	...
	lineItems.forEach((line, lineIndex) => {
		line.words.forEach((word: any, i: any) => {
...
function firstFormat(lineItem: any) {

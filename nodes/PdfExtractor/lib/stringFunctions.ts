...
export function isDigit(charCode: any) {
	return charCode >= MIN_DIGIT_CHAR_CODE && charCode <= MAX_DIGIT_CHAR_CODE;
}

export function isNumber(string: any) {
...
export function hasOnly(string: any, char: any) {
...
export function hasUpperCaseCharacterInMiddleOfWord(text: any) {
...
export function normalizedCharCodeArray(string: any) {
...
export function charCodeArray(string: any) {
	const charCodes = [];
	for (let i = 0; i < string.length; i++) {
...
export function removeLeadingWhitespaces(string: any) {
...
export function removeTrailingWhitespaces(string: any) {
...
export function prefixAfterWhitespace(prefix: any, string: any) {
...
export function suffixBeforeWhitespace(string: any, suffix: any) {
...
export function isListItemCharacter(string: any) {
	if (string.length > 1) {
		return false
	}
...
export function isListItem(string: any) {
	return /^[\s]*[-•–][\s].*$/g.test(string);
}

export function isNumberedListItem(string: any) {
	return /^[\s]*[\d]*[.][\s].*$/g.test(string);
}

export function wordMatch(string1: any, string2: any) {
